            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12">
                        ...
                        <p className="sofia" style={{fontSize:'14px'}}>Your password reset request has been received. A password reset link has been sent to the email address linked to the username provided.</p>
                    </div>
