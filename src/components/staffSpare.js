...
//   }
//   // getStaffEdit = () => {
//   //   fetchData(`/Staff/5`, data => {
//   //     this.setState({ staff: data })
//   //   })
//   //   setTimeout(() => {
//   //     // console.log(this.state.editStaff.person.surname, "meeee")
//   //   }, 7000)
//   // }
...
//           name: (
//             <Link to={"/app/admin/staffprofile"} state={d} className="myLinks">
//               {d.person.surname} {d.person.firstname} {d.person.othername}
//             </Link>
//           ),
//           // <a
//           //   className="myLinks"
//           //   href="/app/admin/EditStaffProfile?id="
//           // >{`${d.person.surname} ${d.person.firstname} ${d.person.othername}`}</a>,
...
//           action: (
//             <Link state={d} to={"/app/admin/EditStaffProfile"}>
...
//       //   console.log(
//       //     "%c Staff Details",
//       //     "background-color: green; font-family:consolas; font-size:18px; color:#fff"
//       //   )
//       //   console.table(this.state.allStaff)
//       // }, 6000)
//     })
//     // this.setSelectedData(staff)
//     // this.getStaffEdit()
...
//       const othernameLower = staff.person.othername
//         ? staff.person.othername.toLowerCase()
//         : ""
//       const mobilenumberLower = staff.person.phoneNumber
//         ? staff.person.phoneNumber.toLowerCase()
//         : ""
//       const rankLower = staff.rank ? staff.rank.name.toLowerCase() : ""
//       const departmentLower = staff.department
//         ? staff.department.name.toLowerCase()
//         : ""

//       const searchValLower = text.toLowerCase()
//       return (
//         surnameLower.includes(searchValLower) ||
//         firstnameLower.includes(searchValLower) ||
//         othernameLower.includes(searchValLower) ||
//         mobilenumberLower.includes(searchValLower) ||
//         rankLower.includes(searchValLower) ||
//         departmentLower.includes(searchValLower)
//       )
//     })
...
//                 Dashboard <span className="h3 text-muted">/Staff Profiles</span>
//               </h1>
...
//                               onChange={e => this.searchStaff(e.target.value)}
...
//                               <label className="mr-2" htmlFor="#filterinline">
//                                 Filter by:{" "}
//                               </label>
...
//                                       <td>
//                                         {new Date(
//                                           staff.person.birthDay
//                                         ).toDateString()}
//                                       </td>
//                                       <td>
//                                         {staff.rank ? staff.rank.name : " - "}
//                                       </td>
//                                       <td>
//                                         {staff.department
...
//                           name="phoneNumber"
//                           onChange={e => {
//                             this.updatePersonItem("phoneNumber", e.target.value)
//                           }}
//                         />
//                       </div>
//                     </div>
...
//                           name="address"
//                           onChange={e => {
//                             this.updatePersonItem("address", e.target.value)
//                           }}
//                         ></textarea>
//                       </div>
//                     </div>
