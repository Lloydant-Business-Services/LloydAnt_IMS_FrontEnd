...
class ViewChangeOfName extends Component {
  state = {
                        ...
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            style={{lineHeight:"30px", textAlign:"center"}}
                              ...
                              className="form-control-label"
                            >
                              I,  <b>{_.upperCase(this.state.staffInfo?.person?.surname)} {_.upperCase(this.state.staffInfo?.person?.firstname)} {_.upperCase(this.state.staffInfo?.person?.othername)},</b> with Staff Number <b>{this.state.staffInfo?.generatedStaffNumber}, </b> from the department of <b>{_.upperCase(this.state.staffInfo?.department?.name)}, previuosly known as {_.upperCase(this.state.staffInfo?.person?.surname)} {_.upperCase(this.state.staffInfo?.person?.firstname)} {_.upperCase(this.state.staffInfo?.person?.othername)},</b> humbly make an official request for a change of Name. I have fufiled and met all neccessary legal requirements to effect this change.<br/><br/>
              In accordance, I am now to be called, addressed and reffered to as <b>{_.upperCase(this.state.conInfo.surname)}, {_.upperCase(this.state.conInfo.firstname)} {_.upperCase(this.state.conInfo.othername)}</b>
...
export default ViewChangeOfName;
